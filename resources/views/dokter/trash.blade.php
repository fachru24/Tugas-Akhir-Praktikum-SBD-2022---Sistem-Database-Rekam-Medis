...
<h4 class="mt-5">Data Trash Dokter</h4>
<div class="form-search" style="float:right">
    <form action="{{ route('dokter.search_trash') }}" method="get" accept-charset="utf-8">
...
<table class="table table-hover mt-2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('dokter.restore', $data->id_dokter) }}" type="button"
