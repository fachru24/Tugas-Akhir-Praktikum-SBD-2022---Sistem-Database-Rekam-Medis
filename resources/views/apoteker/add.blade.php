...
<div class="card mt-4">
    <div class="card-body">
        <h5 class="card-title fw-bolder mb-3">Tambah Data Apoteker</h5>
        <form method="post" action="{{ route('apoteker.store') }}">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_apoteker" name="nama_apoteker">
            </div>
            <div class="mb-3">
